PRACTICAL-1:
SUMMARY:Sorting algorithms arrange data in ascending or desending order using different approches.
        Bubble, Selection and Insertion sorts generally take O(n2)time ,While merge sort average 
        O(n log n) and Quicksort averages O(n log n).
